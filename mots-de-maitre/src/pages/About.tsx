        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-purple-900 to-pink-900 p-1 rounded-lg shadow-xl">
                <img 
              ...
              <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-pink-600 rounded-lg flex items-center justify-center">
