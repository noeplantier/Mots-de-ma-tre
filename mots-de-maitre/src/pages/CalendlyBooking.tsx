...
const CalendlyBooking = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      {/* Header */}
      <header id="header" className="py-16 bg-gradient-to-r from-[#2E2649]/40 to-[#F9AACD]/40">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Réservez votre <span className="text-[#2E2649]">Consultation</span></h1>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-neutral-800 p-6 rounded-lg hover:bg-neutral-700">
              <div className="w-12 h-12 bg-[#2E2649] rounded-full flex items-center justify-center mb-4">
